      ...
      >
        <div className="glass-card p-10 border-white/20">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-3xl font-serif font-bold text-luxury-charcoal dark:text-white">Welcome Back</h1>
            <p className="text-luxury-charcoal/60 dark:text-white/60 text-sm mt-2">Sign in to continue your journey</p>
          </div>
